      ...
      <div>
        ...
        <div className="mt-4 flex flex-wrap gap-3">
          ...
          {physician.acceptingNewPatients === true ? (
            <Badge tone="success">Accepting new patients</Badge>
          ) : null}
          {physician.acceptingNewPatients === false ? (
            <Badge>Not listed as accepting new patients</Badge>
          ) : null}
        </div>
        ...
        {physician.bioHtml ? (
          ...
          <p className="mt-6 text-xl text-lcmc-muted">A biography is not available for this physician.</p>
        )}
        ...
        {physician.locations.length > 0 ? (
          <section className="mt-8">
            <h2 className="text-2xl font-bold text-lcmc-navy">Where to find this physician</h2>
